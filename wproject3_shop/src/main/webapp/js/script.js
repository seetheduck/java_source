function zipCheck(){
	...
	window.open(url, "post", "toolbar=no,width=650,height=300,top=200,left=700,status=yes,scrollbars=yes,menubar=no");
}
...
function idCheck(){
	if(regForm.id.value === ""){
		...
		window.open(url, "id", "width=300,height=150,top=200,left=300");
	}
