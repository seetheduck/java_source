...
public class Ex01Main { // 응용 프로그램의 시작, 즉 main을 위한 클래스일 뿐
	...
	public static void main(String[] args) {
		...
		System.out.println();
		// 자동차 객체를 만들고 싶어..
		Ex01Car car1 = new Ex01Car(); // 참조형 변수 // 클래스 --> 인스턴스화 --> 인스턴스(객체)
		// Ex01Car : 보조기억장치에 있는 Ex01Car.class를 주기억장치로 로딩
		// car1 : 객체 변수 - 객체의 주소를 기억
		// new : 인스턴스화를 위한 키워드
		// Ex01Car() : 생성자를 호출

		System.out.println("Ex01Car 타입의 생성된 객체 주소 car1 : " + car1);
		...
		System.out.println("Ex01Car 타입의 생성된 객체 주소 car2 : " + car2);
		...
		System.out.println(car1.getClass() == car2.getClass()); // ㅌ타입 비교
