...
// - protected : 같은 프로젝트 내에서 유효. 패키지가 다른 경우 자식 클래스만 우효
// - default : 같은 패키지 내에서만 유효. 
// - private : 현재 클래스 내에서만 유효. 다른 클래스 에서는 참조 불가

public class Ex01Car {	// [접근지정자][기타제한자] class 클래스명
	int wheel; // 멤버 필드(전역 변수) : default 접근 지정자
	private int airbag = 1; // [접근지정자][기타제한자] 타입 변수명
	private int speed;	// private 하고 주면 캡슐화
	public String irum;
	
	public Ex01Car() { // 클래스와 이름이 같고 반환형이 없는 메소드 : 생성자(Constructor)
