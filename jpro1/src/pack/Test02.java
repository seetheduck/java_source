...
public class Test02 {
	...
	public static void main(String[] args) {
		...
		System.out.println((3 + 4) * 5); // () 소괄호 내의 연산순위 가장 높음
		
		//System.out.println(a / 0); // 정수연산인 경우 에러 ArithmeticException error
		...
		String ss5 = Integer.toString(5) + 6; // int 기본형 클래스는 Integer(wrapper class)
